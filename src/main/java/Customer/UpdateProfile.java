...
public class UpdateProfile extends javax.swing.JFrame {
        ...
        UpdateProfile.user = user ;
                ...
                for (Customer list : allCustomers) {
                     if (user.toLowerCase().equals(list.getUsername().toLowerCase())){
                        ...
                        emailField.setText(list.geteMail());
                        contactField.setText(list.getContact());
                        dateOfBirthDC.setDate(list.getDOB());
                        usernameField.setText(list.getUsername());
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 170, -1));
        ...
        jPanel3.add(exitLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, -1, 30));
        ...
        jPanel3.add(updateProfileButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, -1, -1));
    ...
    private void updateProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProfileButtonActionPerformed
        boolean match = false ;
        for (Customer list : allCustomers) {
            if(passwordField.getText().equals(list.getPassword())){
                match = true;
            ...
            if(match == true){
                ...
                allCustomers.set(index, i);
                addCustomer();

                JOptionPane.showMessageDialog(null,
                    "Profile Successfully Updated", "Success",
                    JOptionPane.INFORMATION_MESSAGE);

                dispose();
                CustomerDashboard ID = new CustomerDashboard(usernameField.getText());
                ID.show();
            } if(match == false) {
                JOptionPane.showMessageDialog(null,
                    "Incorrect Password, Please type in the correct password to make changes to your profile", "Warning",
    ...
    private void dd(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dd
     ...
     */
     ...
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateProfile(user).setVisible(true);
            }
        });
    }
