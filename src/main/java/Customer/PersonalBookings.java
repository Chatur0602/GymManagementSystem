...
import static Booking.EditBooking.columnsName;
...
public class PersonalBookings extends javax.swing.JFrame {
    private static String [] columnsName = {"Booking ID", "Name", "Slot", "Customer Email", "Instructor Email", "Status"};
    private static String dataRow [] ;
    public static String user ;
    
    BookingIoHandler CIH; 
    public PersonalBookings(String user) {
        CIH = new BookingIoHandler();
        initComponents(); 
        PersonalBookings.user = user ;
        ...
        Format date =new SimpleDateFormat("dd-MM-yyyy HH:mm");
             ...
             for (Booking list : allBookings) {
                if(user.equals(list.getCustomerEmail())){
    ...
    private void initComponents() {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 920, 490));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalBookings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonalBookings(user).setVisible(true);
            }
        });
    }
